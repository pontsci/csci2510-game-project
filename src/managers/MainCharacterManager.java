...
public class MainCharacterManager extends Manager{
    ...
    public MainCharacterManager(Floor floor, ArrayList<Sprite> walls, ArrayList<Sprite> rats){
        ...
        getSprites().add(new MainCharacter(-7, -4, new Vector2f(.4f,.4f), spriteAnimations, floor, walls, rats));
    }
