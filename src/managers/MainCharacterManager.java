...
public class MainCharacterManager extends Manager{
    ...
    public MainCharacterManager(Floor floor, ArrayList<Sprite> walls, ArrayList<Sprite> powerups, ArrayList<Sprite> platforms){
        getSprites().add(new MainCharacter(-7, -4, new Vector2f(.3f,.3f), floor, walls, powerups, platforms));
    }
